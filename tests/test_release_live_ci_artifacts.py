...
""",
    ...
    def test_export_live_ci_artifacts_separates_automation_gate_from_manual_signoffs(self):
        ...
        self.assertEqual(artifact_manifest["report_files"]["summary_markdown"], "release_live_ci_summary.md")
        self.assertEqual(artifact_manifest["report_files"]["release_live_fixture"], "release_live_fixture.json")
        self.assertEqual(artifact_manifest["report_files"]["release_delivery_readiness"], "release_delivery_readiness_release.json")
    ...
    def test_run_release_live_gates_locally_executes_release_replay_and_writes_step_summary(self):
        ...
        self.assertEqual(summary["runtime_assembly"]["route_id"], "local_replay:release:production")
        self.assertEqual(summary["runtime_assembly"]["session_id"], "web-release-001")
        self.assertFalse(payload["prepare_release_fixture"])
        self.assertTrue(payload["release_live_fixture_report_path"].endswith("release_live_fixture.json"))
        self.assertTrue(payload["release_live_fixture_markdown_path"].endswith("release_live_fixture.md"))
