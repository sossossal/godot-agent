...
from agent_system.tools.release_distribution import export_release_distribution_bundle


def main() -> int:
    parser = argparse.ArgumentParser(description="Export a versioned release distribution bundle.")
    parser.add_argument("--project-root", default=".", help="Project root containing docs/支持矩阵与分发说明.md.")
    parser.add_argument("--runtime-root", default="", help="Runtime root containing api_server/static/dist/. Defaults to project root.")
