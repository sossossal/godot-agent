...
from agent_system.tools.release_distribution import export_release_distribution_signing_handoff


def main() -> int:
    parser = argparse.ArgumentParser(description="Export an external signing intake package for a verified release bundle.")
