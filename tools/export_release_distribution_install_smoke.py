...
from agent_system.tools.release_distribution import export_release_distribution_install_smoke


def main() -> int:
    parser = argparse.ArgumentParser(description="Run install/upgrade/uninstall smoke for a versioned release distribution bundle.")
    ...
    payload = export_release_distribution_install_smoke(
        args.project_root,
